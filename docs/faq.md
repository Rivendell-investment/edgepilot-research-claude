# EdgePilotAI Research FAQ — Claude
...
Start a new conversation in the supported Claude workspace and try `Help me choose a strategy` or `Show me the available strategies`.
...
## Where is the OpenAI and Codex version?

Use the official [EdgePilotAI Research for OpenAI and Codex repository](https://github.com/Rivendell-investment/edgepilot-research-openai).
